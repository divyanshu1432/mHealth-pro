...
console.warn(props.event , 'props')
  const getColorAchievements = () => {
    ...
    .then((res)=> { {res.data.response.responseData ? 
      setcolorevent( res.data.response.responseData):setcolorevent([]) }
    })
        ...
        >
          ...
          >
            {/* {Img.map((elem) => {
              return (
                <> */}
                  <img data-tip={_3_D[0]?.achievedDate?_3_D[0]?.achievedDate:''}
                    src={  _3_D[0]?.achievementIcon? _3_D[0]?.achievementIcon:   streak._3_D}
                    style={{ width: 80, height: 80, marginTop: 10 }}
                  />{" "}
                  <ReactTooltip />
                   <img
                   data-tip={_5_D[0]?.achievedDate?_5_D[0]?.achievedDate:''}
                    src={   _5_D[0]?.achievementIcon? _5_D[0]?.achievementIcon:   streak._5_D}
                    style={{ width: 80, height: 80, marginTop: 10 }}
                  />
                   <img
                   data-tip={_7_D[0]?.achievedDate?_7_D[0]?.achievedDate:''}
                    src={  _7_D[0]?.achievementIcon? _7_D[0]?.achievementIcon:    streak._7_D}
                    style={{ width: 80, height: 80, marginTop: 10 }}
                  />
                
                   <img
                   data-tip={_10_D[0]?.achievedDate?_10_D[0]?.achievedDate:''}
                    src={ _10_D[0]?.achievementIcon? _10_D[0]?.achievementIcon:  streak._10_D}
                    style={{ width: 80, height: 80, marginTop: 10 }}
                  />
                   <img
                   data-tip={_14_D[0]?.achievedDate?_14_D[0]?.achievedDate:''}
                    src={  _14_D[0]?.achievementIcon? _14_D[0]?.achievementIcon:   streak._14_D}
                    style={{ width: 80, height: 80, marginTop: 10 }}
                  />
                   <img
                   data-tip={_17_D[0]?.achievedDate?_17_D[0]?.achievedDate:''}
                    src={   _17_D[0]?.achievementIcon? _17_D[0]?.achievementIcon:    streak._17_D}
                    style={{ width: 80, height: 80, marginTop: 10 }}
                  />
                   <img
                   data-tip={_21_D[0]?.achievedDate?_21_D[0]?.achievedDate:''}
                    src={   _21_D[0]?.achievementIcon? _21_D[0]?.achievementIcon:    streak._21_D}
                    style={{ width: 80, height: 80, marginTop: 10 }}
                  />
                   <img data-tip={_28_D[0]?.achievedDate?_28_D[0]?.achievedDate:''}
                    src={  _28_D[0]?.achievementIcon? _28_D[0]?.achievementIcon:   streak._28_D}
                    style={{ width: 80, height: 80, marginTop: 10 }}
                  />
                   <img
                   data-tip={_30_D[0]?.achievedDate?_30_D[0]?.achievedDate:''}
                    src={  _30_D[0]?.achievementIcon? _30_D[0]?.achievementIcon:   streak._30_D}
                    style={{ width: 80, height: 80, marginTop: 10 }}
                  />
                {/* </>
              );
              ...
              return (
                <> */}
                  <img
                    ...
                    src={ _1_K[0]?.achievementIcon? _1_K[0]?.achievementIcon :
                  ...
                  />{" "}
                    ...
                    src={ _2_K[0]?.achievementIcon? _2_K[0]?.achievementIcon :
                  ...
                  />{" "}
                    ...
                    src={ _3_K[0]?.achievementIcon? _3_K[0]?.achievementIcon :
                  ...
                  />{" "}
                    ...
                    src={
                      _5_K[0]?.achievementIcon? _5_K[0]?.achievementIcon :
...
data-tip={_7_K[0]?.achievedDate?_7_K[0]?.achievedDate:''}
                    src={ _7_K[0]?.achievementIcon? _7_K[0]?.achievementIcon :
                  ...
                  />{" "}
                    ...
                    src={ _10_K[0]?.achievementIcon? _10_K[0]?.achievementIcon :
                  ...
                  />{" "}
                    ...
                    src={ _14_K[0]?.achievementIcon? _14_K[0]?.achievementIcon :
                  ...
                  />{" "}
                    ...
                    src={ _17_K[0]?.achievementIcon? _17_K[0]?.achievementIcon :
                  ...
                  />{" "}
                    ...
                    src={ _21_K[0]?.achievementIcon? _21_K[0]?.achievementIcon :
        ...
        >
          ...
          >
                  ...
                  <img
                    ...
                    src={ _1_A[0]?.achievementIcon? _1_A[0]?.achievementIcon : week._1_A}
                    style={{ width: 80, height: 80, marginTop: 10 }}
                  />{" "}
                     <img
                        data-tip={_2_A[0]?.achievedDate?_2_A[0]?.achievedDate:''}
                    src={ _2_A[0]?.achievementIcon? _2_A[0]?.achievementIcon :  week._2_A}
                    style={{ width: 80, height: 80, marginTop: 10 }}
                  />{" "}

<img
   data-tip={_3_A[0]?.achievedDate?_3_A[0]?.achievedDate:''}
                    src=   {   _3_A[0]?.achievementIcon? _3_A[0]?.achievementIcon :  week._3_A}
                    style={{ width: 80, height: 80, marginTop: 10 }}
                  />

<img
   data-tip={_5_A[0]?.achievedDate?_5_A[0]?.achievedDate:''}
                    src={_5_A[0]?.achievementIcon? _5_A[0]?.achievementIcon :  week._5_A}
                    style={{ width: 80, height: 80, marginTop: 10 }}
                  />{" "}

<img   data-tip={_7_A[0]?.achievedDate?_7_A[0]?.achievedDate:''}
                    src={ _7_A[0]?.achievementIcon? _7_A[0]?.achievementIcon :  week._7_A}
                    style={{ width: 80, height: 80, marginTop: 10 }}
                  />{" "}

<img
   data-tip={_10_A[0]?.achievedDate?_10_A[0]?.achievedDate:''}
                    src={  _10_A[0]?.achievementIcon? _10_A[0]?.achievementIcon :    week._10_A}
                    style={{ width: 80, height: 80, marginTop: 10 }}
                  />{" "}
...
<img
   data-tip={_14_A[0]?.achievedDate?_14_A[0]?.achievedDate:''}
                    src={  _14_A[0]?.achievementIcon? _14_A[0]?.achievementIcon :   week._14_A}
                    style={{ width: 80, height: 80, marginTop: 10 }}
                  />{" "}

<img
   data-tip={_17_A[0]?.achievedDate?_17_A[0]?.achievedDate:''}
                    src={ _17_A[0]?.achievementIcon? _17_A[0]?.achievementIcon :  week._17_A}
                    style={{ width: 80, height: 80, marginTop: 10 }}
                  />{" "}

<img   data-tip={_21_A[0]?.achievedDate?_21_A[0]?.achievedDate:''}
                    src={  _21_A[0]?.achievementIcon? _21_A[0]?.achievementIcon :  week._21_A}
                    style={{ width: 80, height: 80, marginTop: 10 }}
                  />{" "}
