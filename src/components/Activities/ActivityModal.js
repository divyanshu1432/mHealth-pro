            ...
            <>
              ...
              >
                <div style={{ width: "50%" }}>
                  ...
                  <input
                    style={{
                      border: errorObj.eventName ? "1px solid red" : 0
                    }}
                ...
                <div style={{ width: "50%" }}>
                  ...
                  <select
                    ...
                    style={{
                      border: errorObj.eventType ? "1px solid red" : 0
                    }}
                    onChange={(e) => {
                ...
                >
                  <div style={{ display: "flex" }}>
                    <div style={{ width: "50%" }}>
                      ...
                      <input
                        style={{
                          border: errorObj.activationCode ? "1px solid red" : 0,
                          background: "#f3f4f6",
                          padding: "6px 10px",
                          borderRadius: 6,
                          fontSize: 12,
                    ...
                    <div style={{ width: "50%" }}>
                      ...
                      <input
                        ...
                        style={{
                          border: errorObj.registrationFees
                            ? "1px solid red"
                            : 0,
                          background: "#f3f4f6",
                          padding: "6px 10px",
                  ...
                  <div style={{ marginTop: 10 }}>
                    ...
                    <input
                      style={{
                        border: errorObj.eventLink ? "1px solid red" : 0,
                        background: "#f3f4f6",
                        padding: "6px 10px",
                        borderRadius: 6,
                        fontSize: 12,
                    ...
                    >
                      ...
                      >
                        ...
                        <DatePicker
                          ...
                          onChange={(e) => handleInputChange("eventEndDate", e)}
                          label='End'
                          outlineVariantDisable={true}
                        />
                      </span>
              ...
              >
                ...
                >
                  <div style={{ width: "100%" }}>
                    ...
                    <input
                      style={{
                        border: errorObj.paymentLink ? "1px solid red" : 0,
                        background: "#f3f4f6",
                        padding: "6px 10px",
                        borderRadius: 6,
                        fontSize: 12,
              ...
              >
                <div style={{ width: "50%" }}>
                  ...
                  <TextField
                    ...
                    style={{
                      width: "95%",
                      border: errorObj.eventDescription ? "1px solid red" : 0
                    }}
                    variant='outlined'
                    multiline
                    value={
                ...
                <div style={{ width: "50%" }}>
                  ...
                  <TextField
                    ...
                    style={{
                      width: "100%",
                      border: errorObj.eventInfo ? "1px solid red" : 0
                    }}
                    variant='outlined'
                    multiline
                    value={
              ...
              >
                ...
                <div style={{ width: "50%" }}>
                  ...
                  <TextField
                    ...
                    style={{
                      width: "100%",
                      border: errorObj.reward ? "1px solid red" : 0
                    }}
                    variant='outlined'
                    multiline
                    value={
              ...
              >
                <div style={{ width: "50%" }}>
                  ...
                  <TextField
                    ...
                    style={{
                      width: "95%",
                      border: errorObj.termAndConditions ? "1px solid red" : 0,
                      border: "0px"
                    }}
                    variant='outlined'
                    multiline
                ...
                <div style={{ width: "50%" }}>
                  ...
                  <TextField
                    ...
                    style={{
                      width: "100%",
                      border: errorObj.subscriptionDetails
                        ? "1px solid red"
                        : 0,
                      border: "0px"
                    }}
