          ...
          {activeStep == 1 && (
            <>
              ...
              >
                <div style={{ width: "50%" }}>
                  <div>
                    <label style={{ fontSize: 12 }}>Event Name</label>
                  ...
                  <input
                    style={{
                      border: errorObj.challengeName ? "1px solid red" : 0
                    }}
                ...
                <div style={{ width: "50%" }}>
                  ...
                  <select
                    ...
                    style={{
                      border: errorObj.challengeType ? "1px solid red" : 0
                    }}
                    onChange={(e) => {
                ...
                >
                  <div style={{ width: "50%" }}>
                    ...
                    <input
                      type='number'
                      style={{
                        border: errorObj.emailId ? "1px solid red" : 0,
                        background: "#f3f4f6",
                        padding: "6px 10px",
                        borderRadius: 6,
                        fontSize: 12,
              ...
              >
                <div style={{ width: "50%" }}>
                  ...
                  <input
                    style={{
                      border: errorObj.registrationCode ? "1px solid red" : 0
                    }}
...
// MODERATOR CODE ENDED HERE  */}
              ...
              >
                <div style={{ width: "50%" }}>
                  ...
                  <TextField
                    ...
                    style={{
                      width: "95%",
                      border: errorObj.description ? "1px solid red" : 0
                    }}
                    variant='outlined'
                    multiline
                    value={
                ...
                <div style={{ width: "50%" }}>
                  <label style={{ width: "100%" }}>Eligibility</label>
                  ...
                  <TextField
                    ...
                    style={{
                      width: "100%",
                      border: errorObj.eligibility ? "1px solid red" : 0
                    }}
                    variant='outlined'
                    multiline
                    value={
              ...
              >
                ...
                <div style={{ width: "50%" }}>
                  <label style={{ width: "100%" }}> Sponsor text </label>
              ...
              >
                <div style={{ width: "50%" }}>
                  <label>Rules</label>
                  {errorObj.rules && <p className='error-text'>Please input</p>}
                  ...
                  <TextField
                    ...
                    style={{
                      width: "95%",
                      border: errorObj.rules ? "1px solid red" : 0
                    }}
                    variant='outlined'
                    multiline
                    value={
                ...
                <div style={{ width: "50%" }}>
                  ...
                  <TextField
                    ...
                    style={{
                      width: "100%",
                      border: errorObj.rewards ? "1px solid red" : 0
                    }}
                    variant='outlined'
                    multiline
                    value={
              ...
              >
                <div style={{ width: "50%" }}>
                  ...
                  <TextField
                    ...
                    style={{
                      width: "95%",
                      border: errorObj.termAndCondition ? "1px solid red" : 0,
                      border: "0px"
                    }}
                    variant='outlined'
                    multiline
                ...
                <div style={{ width: "25%" }}>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("datasourceChangeCount", e.target.value)
                    }
                    style={{ width: "85%" }}
                  />
                </div>
